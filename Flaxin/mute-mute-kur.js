...
exports.run = async (client, message, args) => {
 ...
 if (!message.member.hasPermission("ADMINISTRATOR")) return  message.channel.send(new Discord.MessageEmbed().setColor("RED").setTitle('Bir hata oluştu').setDescription(`Maalesef **Yönetici** adlı yetkin yok!`));
    ...
    .setDescription(`Mute sistemini kurmak için seçenekleri seçin!

    Mute log'u ayarlamak için <a:flaxin_1:824988468182253569> 
    Mute atabilecek yetkiyi ayarlamak için <a:flaxin_2:824988469499658241>
    Muteli rolü ayarlamak için <a:flaxin_3:824988468060618824>
...
.setTitle(`${client.user.username} | Mute Log Kanal Ayarlama`)
.setColor(0x36393F)
...
db.set(`mute.log_${message.guild.id}`, kanal.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Mute Log Kanal Ayarlama`)
.setColor(0x36393F)
.setDescription(`Mute log kanalı başarıyla ${kanal} ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Flaxin`)
...
if (!rol) {
  const ayarlanmadı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Muteli Rolü ayarlama`)
.setColor(0x36393F)
...
db.set(`${message.guild.id}_muted`, rol.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL)  
.setTitle(`${client.user.username} | Muteli Rolü ayarlama`)
.setColor(0x36393F)
.setDescription(`Muteli rolü başarıyla ${rol} olarak seçildi!`)
.setThumbnail(client.user.avatarURL)
.setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
message.channel.send(ayarlandı)
await join.stop()
...
if (!rol) {
  const ayarlanmadı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Mute yetkili ayarlama`)
.setColor(0x36393F)
.setDescription(`Mute yetkili rolünü seçmek için rolü etiketleyin!`)
.setThumbnail(client.user.avatarURL)
.setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
message.channel.send(ayarlanmadı)
}
db.set(`${message.guild.id}_mute.yetkilisi`, rol.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username}| Mute yetkili ayarlama`)
.setColor(0x36393F)
.setDescription(`Mute yetkilisi rolü başarıyla ${rol} olarak seçildi!`)
.setThumbnail(client.user.avatarURL)
.setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
message.channel.send(ayarlandı)
await join.stop()
...
.setDescription(`
Mute Log : 
${message.guild.channels.cache.get(db.get(`mute.log_${message.guild.id}`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
Mute Yetkilisi Rolü : 
${message.guild.roles.cache.get(db.get(`${message.guild.id}_mute.yetkilisi`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
Muteli Rol : 
${message.guild.roles.cache.get(db.get(`${message.guild.id}_muted`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
