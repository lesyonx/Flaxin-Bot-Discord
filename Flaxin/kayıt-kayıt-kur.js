...
exports.run = async (client, message, args) => {
    ...
    let daily = await db.fetch(`kayıt-kur${message.author.id}`);
  ...
  let nrml = await db.fetch(`normalkayit_${message.guild.id}`);
    if (nrml) {
        ...
        db.set(`kayıt-kur${message.author.id}`, Date.now())
      let embed = new Discord.MessageEmbed()
      .setAuthor(message.author.username, message.author.displayAvatarURL({dynamic:true}))
      .setDescription(`Normal Kayıt Sistemini Kurmak İçin Seçenekleri Tek Tek Seçin
  
      Kayıt kanalı ayarlamak için <a:flaxin_1:824988468182253569> 
      Sohbet kanalını ayarlamak için <a:flaxin_2:824988469499658241>
      Kayıt yetkilisini ayarlamak için <a:flaxin_3:824988468060618824>
      Kayıtlı rolünü ayarlamak için <a:flaxin_4:825011472878010379>
      Kayıtsız rolünü ayarlamak için <a:flaxin_5:825011093650276402>
      Kayıt log'u ayarlamak için <a:flaxin_6:838061014016196628>
      ...
      message.channel.send(embed).then(async react => {
          ...
          reaction.emoji.name === "824988468182253569" || "824988469499658241" || "824988468060618824"  || "825011472878010379" || "825011093650276402" ||"838061014016196628" || "767777081672597534" || "770286374695469127" &&
  ...
  .setTitle(`${client.user.username} | Kayıtlı Rol Ayarlama Komutu`)
  .setColor(0x36393F)
  .setDescription(`rolü seçmek için rolü etiketleyin!`)
  .setThumbnail(client.user.avatarURL)
  .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
  message.channel.send(ayarlanmadı)
  }
  db.set(`${message.guild.id}_kayıtlırol.normal`, rol.id)
  const ayarlandı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username}| Kayıtlı Rol Ayarlama Komutu`)
  .setColor(0x36393F)
  .setDescription(`Kayıtlı rolü başarıyla ${rol} olarak seçildi!`)
  .setThumbnail(client.user.avatarURL)
  .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
  ...
  await join.stop()
          ...
          if(reaction.emoji.name === "flaxin_5"){
            ...
            if (!rol) {
              const ayarlanmadı = new Discord.MessageEmbed()
            .setAuthor(client.user.username, client.user.avatarURL())  
            .setTitle(`${client.user.username} | Kayıtsız Rol Ayarlama Komutu`)
            .setColor(0x36393F)
            .setDescription(`kayıtsız rolünü seçmek için rolü etiketleyin!`)
            .setThumbnail(client.user.avatarURL)
            .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
            message.channel.send(ayarlanmadı)
            }
            db.set(`${message.guild.id}_kayıtsızrol.normal`, rol.id)
            const ayarlandı = new Discord.MessageEmbed()
            .setAuthor(client.user.username, client.user.avatarURL())  
            .setTitle(`${client.user.username}| Kayıtsız Rol Ayarlama Komutu`)
            .setColor(0x36393F)
            .setDescription(`Kayıtsız rolü başarıyla ${rol} olarak seçildi!`)
            .setThumbnail(client.user.avatarURL)
            .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
            message.channel.send(ayarlandı)
            await join.stop()
  ...
  if (!rol) {
    const ayarlanmadı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username} | Kayıt Yetkilisi ayarlama`)
  .setColor(0x36393F)
  ...
  db.set(`${message.guild.id}_kayıtyetkilisi.normal`, rol.id)
  const ayarlandı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL)  
  .setTitle(`${client.user.username} | Kayıt Yetkilisi ayarlama`)
  .setColor(0x36393F)
  .setDescription(`Kayıt yetkilisi başarıyla ${rol} olarak seçildi!`)
  .setThumbnail(client.user.avatarURL)
  .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
  message.channel.send(ayarlandı)
  await join.stop()
  ...
  if (!kanal) {
    const ayarlanmadı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username} | Sohbet Kanal Ayarlama`)
  .setColor(0x36393F)
  ...
  db.set(`${message.guild.id}_sohbet.normal`, kanal.id)
  const ayarlandı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username} |  Sohbet Kanal ayarlama`)
  .setColor(0x36393F)
  .setDescription(`Sohbet Kanal ${kanal} olarak başarıyla ayarlandı!`)
  .setThumbnail(client.user.avatarURL())
  .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
  message.channel.send(ayarlandı)
  await join.stop()
      ...
      if(reaction.emoji.name === "flaxin_6"){
        ...
        if (!kanal) {
          const ayarlanmadı = new Discord.MessageEmbed()
        .setAuthor(client.user.username, client.user.avatarURL())  
        .setTitle(`${client.user.username} | Kayıt Log Ayarlama`)
        .setColor(0x36393F)
        .setDescription(`Kaydedilecek kanalı belirtin!`)
        .setThumbnail(client.user.avatarURL())
        .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
        ...
        db.set(`${message.guild.id}_kayıtlog.normal`, kanal.id)
        const ayarlandı = new Discord.MessageEmbed()
        .setAuthor(client.user.username, client.user.avatarURL())  
        .setTitle(`${client.user.username} | Kayıt Log ayarlama`)
        .setColor(0x36393F)
        .setDescription(`Kayıt log ${kanal} olarak başarıyla ayarlandı!`)
        .setThumbnail(client.user.avatarURL())
        .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
        message.channel.send(ayarlandı)
        await join.stop()
  ...
  if (!kanal) {
    const ayarlanmadı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username} | Kayıt Kanal Ayarlama`)
  .setColor(0x36393F)
  .setDescription(`Kaydedilecek kanalı belirtin!`)
  .setThumbnail(client.user.avatarURL())
  .setFooter(`Flaxin`)
  ...
  db.set(`${message.guild.id}_kayıtkanal.normal`, kanal.id)
  const ayarlandı = new Discord.MessageEmbed()
  .setAuthor(client.user.username, client.user.avatarURL())  
  .setTitle(`${client.user.username} | Kayıt Kanal Ayarlama`)
  .setColor(0x36393F)
  .setDescription(`Kayıt kanal başarıyla ${kanal} olarak ayarlandı!`)
  .setThumbnail(client.user.avatarURL())
  .setFooter(`Flaxin`)
  message.channel.send(ayarlandı)
  await join.stop()
  ...
  .setDescription(`
  Kayıt Kanal : 
  ${message.guild.channels.cache.get(db.get(`${message.guild.id}_kayıtkanal.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  Sohbet Kanal : 
  ${message.guild.channels.cache.get(db.get(`${message.guild.id}_sohbet.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  Kayıt Yetkilisi : 
  ${message.guild.roles.cache.get(db.get(`${message.guild.id}_kayıtyetkilisi.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  Kayıtlı : 
  ${message.guild.roles.cache.get(db.get(`${message.guild.id}_kayıtlırol.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  Kayıtsız : 
  ${message.guild.roles.cache.get(db.get(`${message.guild.id}_kayıtsızrol.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  Kayıt Log : 
  ${message.guild.channels.cache.get(db.get(`${message.guild.id}_kayıtlog.normal`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
  ...
  return react.edit(embed)
   ...
   if(reaction.emoji.name === "ast_carpi") {
    ...
    if (cinsiyetkayit) {
      ...
      let embed = new Discord.MessageEmbed()
      .setAuthor(message.author.username, message.author.displayAvatarURL({dynamic:true}))
      .setDescription(`AAAAAAAAAAAAAAA CİNSİYET DENEMEMEMEME Abone sistemini kurmak için seçenekleri seçin!
  ...
  .setColor(0x36393F)
  .setDescription(`Rol seçmek için rolü etiketleyin!`)
  .setThumbnail(client.user.avatarURL)
  .setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
  message.channel.send(ayarlanmadı)
  }
