...
exports.run = async (client, message, args) => {
    ...
    let daily = await db.fetch(`bansistem${message.author.id}`);
 ...
 if (!message.member.hasPermission("ADMINISTRATOR")) return  message.channel.send(new Discord.MessageEmbed().setColor("RED").setTitle('Bir hata oluştu').setDescription(`Maalesef **Yönetici** adlı yetkin yok!`));
	  db.set(`bansistem-kur${message.author.id}`, Date.now())
    let embed = new Discord.MessageEmbed()
    .setAuthor(message.author.username, message.author.displayAvatarURL({dynamic:true}))
    .setDescription(`Ban sistemini kurmak için seçenekleri seçin!

    Ban log'u ayarlamak için <a:flaxin_1:824988468182253569> 
    Ban atabilecek yetkiyi ayarlamak için <a:flaxin_2:824988469499658241>
    Yedek log'u ayarlamak için <a:flaxin_3:824988468060618824>
...
.setTitle(`${client.user.username} | Ban Log Kanal Ayarlama`)
.setColor(0x36393F)
...
db.set(`ban.log_${message.guild.id}`, kanal.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Ban Log Kanal Ayarlama`)
.setColor(0x36393F)
.setDescription(`Ban log kanalı başarıyla ${kanal} ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Flaxin`)
...
db.set(`${message.guild.id}_yedek.ban.log`, kanal.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Yedek Ban Log kanal ayarlama`)
.setColor(0x36393F)
.setDescription(`Yedek ban log kanalı başarıyla  ${kanal} olarak ayarlandı!`)
.setThumbnail(client.user.avatarURL())
.setFooter(`Flaxin`)
message.channel.send(ayarlandı)
await join.stop()
...
if (!rol) {
  const ayarlanmadı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username} | Ban yetkili ayarlama`)
.setColor(0x36393F)
.setDescription(`Ban yetkili rolünü seçmek için rolü etiketleyin!`)
.setThumbnail(client.user.avatarURL)
.setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
message.channel.send(ayarlanmadı)
}
db.set(`${message.guild.id}_ban.yetkilisi`, rol.id)
const ayarlandı = new Discord.MessageEmbed()
.setAuthor(client.user.username, client.user.avatarURL())  
.setTitle(`${client.user.username}| Ban yetkili ayarlama`)
.setColor(0x36393F)
.setDescription(`Ban yetkisi rolü başarıyla ${rol} olarak seçildi!`)
.setThumbnail(client.user.avatarURL)
.setFooter( message.guild.name , client.user.displayAvatarURL({dynamic:true}))
message.channel.send(ayarlandı)
await join.stop()
...
.setDescription(`
Ban Log : 
${message.guild.channels.cache.get(db.get(`ban.log_${message.guild.id}`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
Ban Yetkilisi Rolü : 
${message.guild.roles.cache.get(db.get(`${message.guild.id}_ban.yetkilisi`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
Yedek Log : 
${message.guild.channels.cache.get(db.get(`${message.guild.id}_yedek.ban.log`)) || "<a:ast_carpi:770286374695469127> Henüz ayarlanmamış"}
